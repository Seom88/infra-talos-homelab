...
|------|----------------------|---------------|-----------|
| Pinned talos provider alpha — ADR 002 (upstream issue #352, `enabled: false` until resolved) | `terraform-provider` `siderolabs/talos` | `allowedVersions: =0.12.0-beta.0`, `enabled: false` | — |
